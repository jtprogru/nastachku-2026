...
<!--
25 минут и пять на вопросы — про то, как мы пустили ИИ-ассистента в инцидент-менеджмент облачного провайдера и почему у него до сих пор нет прав на запись. Сразу дисклеймер — следующий слайд.
-->
