...
Починили за 33 минуты от начала разбора: снапшот тома, offline e2fsck с ноды, VM обратно. Процедура была известна: клиент пишет про четвёртый раз, в нашем архиве это третий разбор на этой VM.
